...
function Preview() {
  ...
  useEffect(() => {
    ...
    if (userCard.mode === 'Facebook') {
      setRedirectMessage(`You have selected ${userCard.mode} mode. So preview will redirect to https://${userCard.facebook}`);
    }else if(userCard.mode === 'Youtube'){
      setRedirectMessage(`You have selected ${userCard.mode} mode. So preview will redirect to https://${userCard.youtube}`);
    }
    else if(userCard.mode === 'Spotify'){
      setRedirectMessage(`You have selected ${userCard.mode} mode. So preview will redirect to https://${userCard.spotify}`);
    }else if(userCard.mode === 'Twitter'){
      setRedirectMessage(`You have selected ${userCard.mode} mode. So preview will redirect to https://${userCard.twitter}`);
    }else if(userCard.mode === 'Instagram'){
      setRedirectMessage(`You have selected ${userCard.mode} mode. So preview will redirect to https://${userCard.instagram}`);
    }else if(userCard.mode === 'LinkedIn'){
      setRedirectMessage(`You have selected ${userCard.mode} mode. So preview will redirect to https://${userCard.linkedin}`);
    }
  ...
  return (
    <div className="content">
      <h7 align="center">{redirectMessage}</h7>
      <Row >
