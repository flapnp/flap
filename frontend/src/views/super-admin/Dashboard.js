      ...
      <div className="content">
                ...
                <Row>
                  ...
                  <Col md="8" xs="7">
                    <div className="numbers">
                      <p className="card-category">Card</p>
        ...
        <Row>
          <Col md="4">
            <Card>
              <CardHeader>
                <CardTitle tag="h5">Available Card Modes</CardTitle>
                {/* <p className="card-category">Card Types</p> */}
              </CardHeader>
              ...
              <CardFooter>
                <hr />
                <div className="stats">
                  <i className="fa fa-book text-danger" /> Add Card Modes
                </div>
              </CardFooter>
            </Card>
          </Col>
            ...
            <Card className="card-chart">
              ...
              <CardFooter>
                <div className="chart-legend">
                  <i className="fa fa-circle text-info" /> User
                </div>
                <hr />
